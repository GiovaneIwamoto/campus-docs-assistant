...
def retrieve(query: str, pinecone_api_key: str, pinecone_index_name: str, embedding_model_provider: str, embedding_model: str, openai_api_key: str = None) -> tuple[str, List]:
